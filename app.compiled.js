...
var background = _react2.default.createElement('img', { className: 'background', src: '/images/ocean.jpg', alt: 'ocean' });
var images = [];

var displayFact = function displayFact(animal) {
  return function (event) {
    var facts = _animals.animals[animal].facts;
